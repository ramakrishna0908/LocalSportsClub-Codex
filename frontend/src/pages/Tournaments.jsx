...
export default function Tournaments() {
  ...
  const [form, setForm] = useState({ name: "", description: "", matchType: "singles", tournamentDate: "", maxPlayers: "" });
  ...
  const createTournament = async () => {
    ...
    try {
      ...
      setShowCreate(false);
      setForm({ name: "", description: "", matchType: "singles", tournamentDate: "", maxPlayers: "" });
      fetchTournaments();
    } catch (err) {
